...
class CNN(tf.keras.Model):
    def __init__(self, args):
        ...
        self.conv_layer1 = Conv2D(32, kernel_size=3, strides=(1, 1), padding='same', activation='relu',
                                  input_shape=(args.fidelity, args.fidelity, self.num_time_steps), name='input_layer')
